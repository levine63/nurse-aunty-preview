...
This repository contains only the runtime files needed by the static web app, copied from `levine63/mamma-app` commit `e54f51c`. It deliberately excludes private project history.
