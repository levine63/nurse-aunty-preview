...
This repository contains only the runtime files needed by the static web app, copied from `levine63/mamma-app` commit `68dfc41`. It deliberately excludes the self-contained `standalone.html` file and private project history.
