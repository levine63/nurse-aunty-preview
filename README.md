...
This repository contains only the runtime files needed by the static web app, copied from `levine63/mamma-app` commit `99347e4`. It deliberately excludes private project history.
